    ...
    <nav class="bg-white border-gray-200 border-b dark:bg-gray-900 dark:border-gray-800">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="flex items-center md:order-2">
          ...
          <!-- 白天黑夜切换 -->
          <button @click="toggleDark()" class="ml-1 mr-4 vt-switch vt-switch-appearance" type="button" role="switch"
                  aria-label="切换深色模式"
          ...
          <button type="button" @click="clickSearchBtn"
            ...
            <span
                class="px-2 py-[1px] flex-none text-xs border text-gray-400 rounded dark:border-gray-600">Ctrl K</span>
          </button>
